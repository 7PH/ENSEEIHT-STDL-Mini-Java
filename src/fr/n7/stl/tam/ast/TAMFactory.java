...
/**
 * Factory to build abstract syntax tree nodes for the MiniJava language.
 * @author Marc Pantel
 *
 */
public interface TAMFactory {
	...
	/**
	 * Build a MiniJava Push instruction AST node.
	 * @param _size Size of the memory chunk that is added on top of the stack.
	 * @return A MiniJava Push instruction AST node.
	 */
	public TAMInstruction createPush(int _size);
	
	/**
	 * Build a MiniJava Pop instruction AST node.
	 ...
	 * @return A MiniJava Pop instruction AST node.
	 */
	public TAMInstruction createPop(int _keep, int _remove);
	
	/**
	 * Build a MiniJava Load instruction AST node.
	 ...
	 * @return A MiniJava Load instruction AST node.
	 */
	public TAMInstruction createLoad(Register _register, int _offset, int _size);

	/**
	 * Build a MiniJava integer constant Load instruction AST node.
	 * @param _value Value of the integer constant that is copied on the stack.
	 * @return A MiniJava integer constant Load instruction AST node.
	 */
	public TAMInstruction createLoadL(int _value);
	
	/**
	 * Build a MiniJava address Load instruction AST node whose execution
	 ...
	 * @return A MiniJava address Load instruction AST node.
	 */
	public TAMInstruction createLoadA(Register _register, int _offset);
	
	/**
	 * Build a MiniJava address Load address instruction AST node whose execution
	 * loads an address on the stack.
	...
	/**
	 * Build a MiniJava Load Immediate instruction AST node whose execution will pop
	 ...
	 * @return A MiniJava Load Immediate instruction AST node.
	 */
	public TAMInstruction createLoadI(int _size);
	
	/**
	 * Build a MiniJava Store instruction AST node whose execution will copy from the stack
	 ...
	 * @return A MiniJava Store instruction AST node.
	 */
	public TAMInstruction createStore(Register _register, int _offset, int _size);
	
	/**
	 * Build a MiniJava Store Immediate instruction AST node whose execution will pop a memory
	 * address from the stack and then copy a memory chunk of the provided size to that
	 * address.
	 * @param _size : Size of the memory chunk that is copied.
	 * @return A MiniJava Store Immediate instruction AST node.
	 */
	public TAMInstruction createStoreI(int _size);

	/**
	 * Build a MiniJava Jump instruction AST node whose execution will transfer the control
	 ...
	 * @return A MiniJava Jump instruction AST node.
	 */
	...
	/**
	 * Build a MiniJava conditional Jump instruction AST node whose execution will transfer
	 ...
	 * @return A MiniJava conditional Jump instruction AST node.
	 */
	...
	/**
	 * Build a MiniJava Halt instruction AST node whose execution will halt the program.
	 *  @return A MiniJava Halt instruction AST node.
	 */
	public TAMInstruction createHalt();

	/**
	 * Build a MiniJava Call instruction AST node whose execution will build a call frame
	 ...
	 * @return A MiniJava Call instruction AST node.
	 */
	...
	/**
	 * Build a MiniJava Call Immediate instruction AST node whose execution will pop an address
	 ...
	 * @param _frame The caller frame in the call stack.
	 * @return A MiniJava Call Immediate instruction AST node.
	 */
	public TAMInstruction createCallI(Register _frame);

	/**
	 * Build a MiniJava Return instruction AST node whose execution will pop a memory chunk of the
	 ...
	 * @return A MiniJava Return instruction AST node.
	 */
	public TAMInstruction createReturn(int _keep, int _remove);

	/**
	 * Build an empty MiniJava fragment AST node.
	 * @return An empty MiniJava fragment AST node.
	 */
	public Fragment createFragment();

	/**
	 * Build a MiniJava fragment AST node that executes a sequence of TAMInstruction.
	 * @param _instructions The sequence of TAMInstruction that makes the fragment.
	 * @return A MiniJava fragment AST node containing a sequence of TAMInstruction.
	 */
	public Fragment createFragment(List<TAMInstruction> _instructions);

	/**
	 * Build a MiniJava binary operator instruction AST node whose execution will pop two
	 ...
	 * @return A MiniJava instruction AST node corresponding to a binary operator.
	 */
	...
	/**
	 * Build a MiniJava unary operator instruction AST node whose execution will pop one
	 ...
	 * @return A MiniJava instruction AST node corresponding to an unary operator.
	 */
